...
const FRONT_VERSION_URL = 'https://github.com/Cipherem/cipherscan-frontend';
const FRONT_COMMIT_URL = 'https://github.com/Cipherem/cipherscan-frontend';
  ...
  const renderProjectInfo = React.useCallback((gridArea?: GridProps['gridArea']) => {
    return (
      <Box gridArea={ gridArea }>
        <Link fontSize="xs" href="https://www.cipherem.com/">cipherem.com</Link>
        <Text mt={ 3 } fontSize="xs">
          The Official Web3 Explorer of Cipherem, the ZK General Purpose Blockchain
        </Text>
